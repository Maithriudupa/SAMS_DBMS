...
export default function AssignmentTable(props) {
  ...
  const [assignment,setAssignment] = React.useState('');
    ...
    const update= (assignment_id)=>{
    
      Axios.put("http://localhost:3001/Admin/updateAssignment",{
     ...
     {posts.map((val) => (
        ...
        <TableHead>
          ...
          <IconButton aria-label="expand row" size="small" onClick={() => setOpen(!open)}>
            {open ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
              ...
              <Button variant="contained" color="primary"  onClick={()=>{Delete(val.assignment_id)}} >
          Delete
        </Button>
              </StyledTableCell>
      ...
      <TableRow>
       ...
       <TextField
        ...
        <Button variant="contained" color="primary" onClick={()=>{update(val.assignment_id)}} >
          Update
        </Button>
